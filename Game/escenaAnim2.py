...
class EscenaAnimacion2(EscenaPyglet, pyglet.window.Window):
    ...
    def __init__(self, director):
        ...
        # La imagen de fondo
        self.imagen = pyglet.image.load('images/puerta.PNG')
        ...
        self.animacionTextoFrames = [
            pyglet.image.AnimationFrame(pyglet.image.load('images/menu_animacion1/texto6.png'), 7.5),
            ]
        ...
        self.animacionPrincipalFrames = [pyglet.image.AnimationFrame(pyglet.image.load('images/dibujo1.png'),8)]
    ...
    def terminarEscena(self):
        ...
        escena = EscenaAnimacion3(self.director)
