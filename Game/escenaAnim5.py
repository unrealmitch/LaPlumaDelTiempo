...
class Animacion( pyglet.window.Window):
    ...
    def __init__(self):
        ...
        self.animacionTextoFrames = [
            pyglet.image.AnimationFrame(pyglet.image.load('images/menu_animacion1/texto14.png'), 14.5),
            ]
        ...
        self.animacionPrincipalFrames = [pyglet.image.AnimationFrame(pyglet.image.load('images/dibujo1.png'),15)]
        
        pyglet.clock.schedule_once(self.aparecerPrincipal, 1)

        self.animacionLiderFrames = [pyglet.image.AnimationFrame(pyglet.image.load('images/lider.png'),15)]
