...
class EscenaAnimacion3(EscenaPyglet, pyglet.window.Window):
    ...
    def __init__(self, director):
        ...
        self.animacionPrincipalFrames = [pyglet.image.AnimationFrame(pyglet.image.load('images/dibujo1.png'),64)]
        
        pyglet.clock.schedule_once(self.aparecerPrincipal, 1)

        self.animacionLiderFrames = [pyglet.image.AnimationFrame(pyglet.image.load('images/lider.png'),64)]
